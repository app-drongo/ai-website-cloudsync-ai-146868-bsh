...
const DEFAULT_HERO = {
  ...
  title: 'Sync your data across clouds',
  titleHighlight: 'instantly',
  subtitle:
    'CloudSync AI delivers real-time data synchronization across all major cloud platforms with enterprise-grade security and global performance.',
  primaryCTA: 'Start Free Trial',
  secondaryCTA: 'Book a Demo',
  primaryCTAHref: '/signup',
  secondaryCTAHref: '/demo',
  feature1Icon: 'zap',
  feature1Text: 'Real-time sync',
  feature2Icon: 'shield',
  feature2Text: 'Bank-level security',
  feature3Icon: 'globe',
  feature3Text: 'Global CDN',
  trustedByText: 'Trusted by Fortune 500 companies worldwide',
