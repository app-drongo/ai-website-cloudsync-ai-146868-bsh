...
const DEFAULT_CONTACT = {
  badge: 'Contact Us',
  mainTitle: 'Ready to Sync Your',
  mainTitleHighlight: 'Enterprise Data?',
  mainDescription:
    'Get started with CloudSync AI today. Our enterprise team will help you implement seamless data synchronization across all your cloud platforms.',
  formTitle: 'Request Enterprise Demo',
  formDescription:
    'Schedule a personalized demo and see how Fortune 500 companies sync their data instantly with CloudSync AI.',
  submitButton: 'Request Demo',
  contactSectionTitle: 'Talk to Our Experts',
  method1Title: 'Enterprise Sales',
  method1Description: 'Discuss your data sync needs',
  method1Contact: 'enterprise@cloudsync.ai',
  method2Title: 'Technical Support',
  method2Description: 'Get implementation help',
  method2Contact: '+1 (800) SYNC-NOW',
  method3Title: 'Live Chat',
  method3Description: 'Instant technical support',
  method3Contact: 'Available 24/7 for Enterprise',
  officesSectionTitle: 'Global Data Centers',
  office1City: 'Silicon Valley',
  office1Address: '2500 Cloud Drive, Palo Alto, CA',
  office1Timezone: 'PST (UTC-8)',
  office2City: 'New York',
  office2Address: '1 Data Plaza, Manhattan, NY',
  office2Timezone: 'EST (UTC-5)',
  office3City: 'London',
  office3Address: '10 Sync Street, Canary Wharf',
  office3Timezone: 'GMT (UTC+0)',
  hoursTitle: 'Support Hours',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '6:00 AM - 8:00 PM',
  ...
  supportNote: '24/7 real-time monitoring and support for all Enterprise customers',
  nameLabel: 'Full Name *',
  ...
  messageLabel: 'Data Sync Requirements *',
  messagePlaceholder:
    'Tell us about your current data infrastructure, cloud platforms, and synchronization challenges...',
} as const;
