...
const DEFAULT_FOOTER = {
  logoText: 'CloudSync AI',
  companyDescription:
    'Sync your data across clouds instantly with enterprise-grade security. Trusted by Fortune 500 companies for real-time data synchronization and global CDN delivery.',
  contactEmail: 'hello@cloudsync.ai',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Cloud Street, Suite 500',
  newsletterTitle: 'Stay Synced',
  newsletterPlaceholder: 'Enter your email for updates',
  newsletterDisclaimer:
    'Get the latest CloudSync AI updates and features. No spam, unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 CloudSync AI. All rights reserved.',
  madeWithText: 'by CloudSync AI team',
  socialText: 'Follow us:',
  social1Href: 'https://twitter.com/cloudsyncai',
  social2Href: 'https://facebook.com/cloudsyncai',
  social3Href: 'https://instagram.com/cloudsyncai',
  social4Href: 'https://linkedin.com/company/cloudsyncai',
  social5Href: 'https://github.com/cloudsyncai',
} as const;
